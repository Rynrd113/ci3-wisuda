        ...
        <div class="col-12 col-lg-3">
            ...
            <div class="card">
                ...
                <div class="recent-message d-flex px-4 py-3">
                    <div class="name ms-4">
                        <h5 class="mb-1">Alasan Foto Tidak Valid</h5>
                        <h6 class="text-muted mb-0">Foto tidak memenuhi kriteria yang ditentukan.</h6>
                    </div>
                </div>
                <div class="recent-message d-flex px-4 py-3">
                    <div class="name ms-4">
                        <h5 class="mb-1">Status Pembayaran</h5>
                        <h6 class="text-muted mb-0">Pembayaran telah diterima.</h6>
                    </div>
                </div>
                <div class="recent-message d-flex px-4 py-3">
                    <div class="name ms-4">
                        <h5 class="mb-1">Status Pengambilan Toga</h5>
                        <h6 class="text-muted mb-0">Toga Sudah di Ambil.</h6>
                    </div>
    </section>
</main>